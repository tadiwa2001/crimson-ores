/* ============================================================
   ...
   2. Give it a unique URL-safe `id` (e.g. "smart-torch").
   ...
   5. Optionally list related project ids in `related`.
   ============================================================ */
...
(function () {
  ...
  var projects = [
    {
      ...
      efficiencyBenefits: ['Teams can locate personnel and respond faster'],
      sustainabilityBenefits: ['A durable, integrated device that consolidates safety and tracking'],
      status: 'Prototype',
      statusDescription:
        'Prototype — the Smart Torch is being developed and refined by Crimson Ores.',
      featured: true,
      related: ['smart-ventilation-system'],
      coverImage: 'assets/images/projects/smart-torch/cover.jpeg',
      gallery: [
        { src: 'assets/images/projects/smart-torch/cover.jpeg', caption: 'Smart Torch' },
        { src: 'assets/images/projects/smart-torch/screenshot-01.jpeg', caption: 'Smart Torch — additional view' }
      ]
    },
    {
      id: 'solarwindlass',
      ...
      safetyBenefits: ['Cuts physical strain on miners', 'Reduces risk compared to manual hand-cranking'],
      efficiencyBenefits: ['Mechanizes a slow, manual task'],
      sustainabilityBenefits: ['Runs on solar power instead of manual or fuel-driven effort'],
      status: 'Prototype',
      statusDescription:
    ...
    },
    {
      ...
      efficiencyBenefits: ['Faster, more controlled blasting initiation'],
      sustainabilityBenefits: ['Self-generating design avoids disposable batteries'],
      status: 'Prototype',
      statusDescription:
    ...
    {
      id: 'construction-material-from-waste',
      ...
      safetyBenefits: ['Reduces waste rock stockpiles on site'],
      efficiencyBenefits: ['Creates value from material that would otherwise be discarded'],
    ...
    },
    {
      ...
      efficiencyBenefits: ['Provides a self-sufficient water source without boreholes or built facilities'],
      sustainabilityBenefits: [
    ...
    },
    {
      ...
      safetyBenefits: ['Prevents tunnel collapses', 'Protects miners from rockfalls'],
      efficiencyBenefits: ['Reusable, relocatable ground support'],
      sustainabilityBenefits: ['Reinforces existing workings for safer, longer-lived tunnels'],
      status: 'Prototype',
      statusDescription:
        'Prototype — the Rock Support Device is being developed and refined by Crimson Ores.',
      featured: false,
      related: ['shot-exploder'],
      coverImage: 'assets/images/projects/rock-support-device/cover.svg',
      gallery: [
        { src: 'assets/images/projects/rock-support-device/cover.svg', caption: 'Rock Support Device' }
      ]
    },
    {
      id: 'smart-ventilation-system',
      ...
      sustainabilityBenefits: ['Lowers the energy consumption of round-the-clock ventilation'],
      status: 'Prototype',
      statusDescription:
        'Prototype — the Smart Ventilation System is being developed and refined by Crimson Ores.',
      featured: false,
      related: ['smart-torch'],
      coverImage: 'assets/images/projects/smart-ventilation-system/cover.jpeg',
      gallery: [
        { src: 'assets/images/projects/smart-ventilation-system/cover.jpeg', caption: 'Smart Ventilation System' },
        { src: 'assets/images/projects/smart-ventilation-system/screenshot-01.jpeg', caption: 'Smart Ventilation System — component view' }
      ]
    }
  ];
  ...
  /* ---------- Related innovations helper ---------- */
  function relatedHTML(project) {
    var ids = project.related || [];
    if (!ids.length) return '';
    var links = ids.map(function (id) {
      var rel = getProjectById(id);
      if (!rel) return '';
      return '<a class="chip-link" href="projects.html?id=' + rel.id + '">' + rel.title + '</a>';
    }).join('');
    if (!links) return '';
    return '<section class="pd-section"><h3>Related Innovations</h3><div class="related">' + links + '</div></section>';
  }
  ...
  function renderDetail(project) {
    ...
    var benefits =
      '<div class="pd-benefit"><h4>' + ICON_SHIELD + 'Safety Objective</h4><ul>' + listHTML(project.safetyBenefits) + '</ul></div>' +
      '<div class="pd-benefit"><h4>' + ICON_GAUGE + 'Efficiency Objective</h4><ul>' + listHTML(project.efficiencyBenefits) + '</ul></div>' +
      '<div class="pd-benefit"><h4>' + ICON_LEAF + 'Sustainability Objective</h4><ul>' + listHTML(project.sustainabilityBenefits) + '</ul></div>';
    ...
    inner.innerHTML =
      '<div class="project-detail">' +
        '<a class="pd-back" href="projects.html">' + ICON_BACK + 'All Innovations</a>' +
        '<div class="pd-head">' +
          '<div>' +
        ...
        '<div class="pd-two-col">' +
          ...
          '<div class="pd-box"><h4>The Crimson Ores Solution</h4><p>' + project.solution + '</p></div>' +
        '</div>' +
        ...
        '<section class="pd-section"><h3>Development Status</h3>' +
